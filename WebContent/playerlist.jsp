...
<div id="search">
  <form action="result.jsp" method="post" name="form1" align = "center" >
    ...
    <form name="form1" action ="servlet/Browseplayer" method = "post">
        <table border ="1" align = "center" style="border-collapse:collapse;">
            ...
            <%for(int i = 0 ; i<list.size();i++) {
                ...
                <tr align="center" >
                <td><img src="<%=player.getUrl() %>"></td> 
                <td><a href="ServletViewPlayer?PlayerId=<%=player.getPid() %>"><%=player.getPname()%></a></td>
